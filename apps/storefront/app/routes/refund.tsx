    ...
    <Container className="py-12">
      <div className="max-w-4xl mx-auto">
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700">To qualify for a return, please make sure that:</p>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700">Some items are not eligible for returns, including:</p>
          <ul className="list-disc pl-6 text-gray-700">
            <li>Gift cards.</li>
        ...
        <section className="mb-10">
          ...
          <ol className="list-decimal pl-6 text-gray-700">
            <li className="mb-4">
              ...
              <ul className="list-disc pl-6 text-gray-700">
                <li>
                  By visiting this page on our website: <a href="/contact-us" className="text-blue-500 underline">Contact Us</a>
                </li>
              </ul>
            </li>
            <li>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700">
            If your product is defective or damaged and you need to exchange it for the same item, contact us at <a href="/contact-us" className="text-blue-500 underline">Contact Us</a> and send your item to the address we provide.
          </p>
        </section>
